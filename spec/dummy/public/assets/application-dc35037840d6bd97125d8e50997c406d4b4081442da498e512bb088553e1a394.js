...
(function() {
  ...
  DataTableBuilder = (function() {
    ...
    DataTableBuilder.prototype.go = function() {
      var div;
      div = $('table#users');
      this.initTable({
        container: div
    ...
    DataTableBuilder.prototype.initTable = function(arg) {
      var container, params, ref, settings;
      ref = arg != null ? arg : {}, container = ref.container, params = ref.params;
      if (container.length > 0) {
        if (params == null) {
          params = {};
        }
        settings = $.extend({}, this.defaultOptions, params);
        settings = $.extend({}, settings, {
          language: Chaltron.locales('datatable')
        });
        return container.DataTable(settings);
      }
    };
  ...
  $(function() {
    return $('form#ldap_create').on('submit', function(e) {
      var count, flash, i, j, label, message, ref, results;
      count = $('table#ldap_create').DataTable().rows({
        selected: true
      }).count();
      if (count === 0) {
      ...
      for (i = j = 0, ref = count - 1; 0 <= ref ? j <= ref : j >= ref; i = 0 <= ref ? ++j : --j) {
        results.push($('<input/>', {
          ...
          type: 'hidden',
          multiple: 'multiple',
          value: $('table#ldap_create').DataTable().rows({
            selected: true
          }).data()[i][1]
        }).appendTo(this));
      }
...
(function() {
  this.Chaltron = (function() {
    function Chaltron() {}

    Chaltron.locales = function(field) {
      var lang, ref, ret;
      lang = (ref = Chaltron.prototype.lang) != null ? ref : 'en';
      ret = (function() {
        switch (lang) {
          case 'it':
            return {
  ...
  $(function() {
    var ref;
    return moment.locale((ref = Chaltron.prototype.lang) != null ? ref : 'en');
  });
